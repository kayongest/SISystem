...
<div class="container-fluid p-0">
    ...
    <div id="dashboardOverviewSection" class="hidden-section px-4 pb-5">
        ...
        <div class="row mb-4">
            <div class="col-sm-3">
                <div class="card bg-primary text-white p-4 rounded-4 border-0">Total: <?php echo $stats['total_items']; ?></div>
            </div>
            <div class="col-sm-3">
                <div class="card bg-success text-white p-4 rounded-4 border-0">Available: <?php echo $stats['available']; ?></div>
            </div>
            <div class="col-sm-3">
                <div class="card bg-info text-white p-4 rounded-4 border-0">In Use: <?php echo $stats['in_use']; ?></div>
            </div>
            <div class="col-sm-3">
                <div class="card bg-dark text-white p-4 rounded-4 border-0">Categories: <?php echo $stats['categories']; ?></div>
            </div>
        </div>
