        ...
        <?php if ($is_technician): ?>
                ...
                <div class="glass-card text-center">
                    ...
                    <div id="scanner-active-controls" style="display: none;" class="py-2">
                        ...
                        <div class="px-3 mt-3" id="camera-select-container" style="display: none;">
                            ...
                            <select id="mobile-camera-select" class="form-select bg-dark text-white border-glass" style="font-size: 0.85rem; border-radius: 12px; border: 1px solid var(--border-glass);"></select>
                        </div>
                    </div>
                </div>
            ...
            <div class="app-view" id="view-history">
                ...
                <div class="row g-2 mb-3">
                    ...
                    <div class="col-6">
                        <select id="tech-status-filter" class="form-select bg-dark text-white border-glass" style="font-size: 0.85rem; border-radius: 12px; height: 100%; border: 1px solid var(--border-glass);" onchange="filterTechBatchesLocal()">
        ...
        <?php elseif ($is_driver): ?>
            ...
            <div class="app-view" id="view-history">
                ...
                <div class="row g-2 mb-3">
                    ...
                    <div class="col-6">
                        <select id="driver-status-filter" class="form-select bg-dark text-white border-glass" style="font-size: 0.85rem; border-radius: 12px; height: 100%; border: 1px solid var(--border-glass);" onchange="filterDriverBatchesLocal()">
                            <option value="">All Statuses</option>
                            <option value="pending">Pending</option>
                            <option value="approved">Approved</option>
                            <option value="completed">Completed</option>
        ...
        <?php else: ?>
            ...
            <div class="app-view" id="view-history">
                ...
                <div class="row g-2 mb-3">
                    ...
                    <div class="col-6">
                        <select id="ctrl-status-filter" class="form-select bg-dark text-white border-glass" style="font-size: 0.85rem; border-radius: 12px; height: 100%; border: 1px solid var(--border-glass);" onchange="filterCtrlBatchesLocal()">
                            <option value="">All Statuses</option>
                ...
                .then(d => {
                    if (d.success && d.batch) {
                        ...
                        (b.items || []).forEach(item => {
                            itemsHtml += `
                                <div class="p-2 mb-2 rounded bg-dark border-1 border-secondary" style="font-size: 0.85rem;">
                        ...
                        const html = `
                            ...
                            <div class="glass-card bg-dark border-0 p-3 mb-3" style="font-size: 0.88rem;">
                                <div class="row g-2">
                ...
                .then(d => {
                    if (d.success && d.data) {
                        ...
                        const html = `
                            ...
                            <div class="glass-card bg-dark border-0 p-3 mb-4" style="font-size: 0.88rem;">
                                <div class="row g-2">
