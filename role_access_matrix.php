...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['reset_default'])) {
    ...
    try {
        ...
        $default_permissions = [
            ...
            'technician' => [
                'view_dashboard',     // ID: 1
                'technician_batch_history',   // ID: 29
                'scan_bulk'           // ID: 30
            ],
            'user' => [
                'view_dashboard',     // ID: 1
...
<body>
    <?php
    // Include the page header (which outputs the compact header bar)
    require_once 'views/partials/page_header.php';
    ?>
