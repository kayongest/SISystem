...
// Bind parameters - 23 parameters (status and created_at are hardcoded)
$stmt->bind_param(
    "sisisssssssssssssssssss",  // 23 characters for 23 parameters
    ...
    $transportDate                  // 23 - string (can be null)
);
