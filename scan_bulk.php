...
<body>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" class="form-control" id="transportDriver" placeholder="Driver name">
                                                        </div>
                                                        <div class="col-md-3">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="jobSheet">
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-select" id="stockControllerSelect" required>
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $sc['id']; ?>"
                                                                ...
                                                                data-department="<?php echo htmlspecialchars($sc['department'] ?? ''); ?>"
                                                                <?php echo ($sc['id'] == $stock_controller_id) ? 'selected' : ''; ?>>
                                                                <?php echo htmlspecialchars(($sc['full_name'] ?? $sc['username']) . ' (' . ($sc['department'] ?? 'Stock Controller') . ')'); ?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </select>
    ...
    <script>
            ...
            items.forEach(item => {
                ...
                itemElement.innerHTML = `
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-sm btn-success" onclick='addSearchedItemToBatch(${JSON.stringify(item)})'>
        ...
        function addSearchedItemToBatch(item) {
            ...
            showNotification('success', `Added "${item.item_name}" to batch`);
        }
        ...
        function processScannedItem(scanData) {
            ...
            if (extractedId && extractedName && extractedName.includes('TV Screen')) {
                ...
                playBeep();
                showNotification('success', `Added "${extractedName}" from QR code`);
                return;
            }
        ...
        function addToBatch(item) {
            ...
            if (exists) {
                showNotification('warning', `Item "${item.name}" is already in the batch`);
                return;
            }
        ...
        function submitBatch() {
            ...
            const batchData = {
                ...
                transport: {
                    ...
                    driver: document.getElementById('transportDriver')?.value || null,
